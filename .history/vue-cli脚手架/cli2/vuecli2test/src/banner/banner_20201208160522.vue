...
<script>
import imgJianzhuwu from './svgs/jianzhuwu.jpg'
import wuzhen from './svgs/乌镇运营中心.png'
import gongyuan from './svgs/乌镇人民公园.png'
...
/*     
    .p3 {
        transform: translate3d(195px, 0, 0) scale(1.6);
        opacity: 1;
        z-index: 4;
    }
    
    .p4 {
        transform: translate3d(800px, 0, 0) scale(1.04);
        opacity: 0;
        z-index: 3;
    } */
